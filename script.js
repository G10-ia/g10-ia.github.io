document.addEventListener("DOMContentLoaded", () => {
  ...
  function construirHtmlDetalleActividadAdmin(userId) {
    ...
    if (!registros.length) {
      return "<div class='actividad-detalle-vacio'>No hay ingresos detallados registrados todavia</div>";
    }
  ...
  if (selectOrdenActividadAdmin) {
    selectOrdenActividadAdmin.addEventListener("change", () => {
      ordenActividadAdmin = selectOrdenActividadAdmin.value === "asc" ? "asc" : "desc";
      renderizarActividadAdmin();
    });
  }
